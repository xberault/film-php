...
<html>
    ...
    <body class="text-left">
        <main class='container'>
            ...
            $showFilm = "SELECT idFilm, titreFilm, dateRealisation, nom, prenom, genre, synopsis, posterPath FROM FILM NATURAL JOIN REALISE NATURAL JOIN PERSONNE where idPersonne='".$_REQUEST['id']."'limit 100000";
